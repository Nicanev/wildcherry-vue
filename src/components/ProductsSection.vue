  ...
  .products__container
    ...
    ul.products__list
        li.products__product.card(v-for="product in products")
          .card__img
            img(src="@/assets/img/products/product_1.jpg", alt="Nothing Phone")
            .card__favourite
            ...
            .card__advertisement.active Реклама
          .card__body
            .card__price
              .card__current-price {{ product.currentPrice }}
              .card__old-price.active {{ product.oldPrice }}
...
export default {
  ...
  data() {
    return {
      products: [
        {
          title: "Смартфон Nothing Nothing Phone 1 8/256 ГБ, черный",
          currentPrice: "41 613 ₽",
          oldPrice: "49 900 ₽",
          discount: "-52%",
          numReview: "1 336",
